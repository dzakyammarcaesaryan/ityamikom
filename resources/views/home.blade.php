    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"><img
                    src="{{ asset('landing-page/assets/img/navbar-brand-ity.png') }}" alt="..." /></a>
        ...
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading ">ITY Press adalah unit pelaksana teknis Institut Teknologi
                    Yogyakarta (ITY) yang didirikan pada 18 Maret 2016. Lembaga ini menyediakan buku, jurnal, majalah,
                    dan e-book berkualitas tinggi bagi civitas akademika ITY dan masyarakat. ITY Press berkomitmen
                    menjaga mutu dan profesionalisme, serta terus beradaptasi dengan perkembangan digital untuk layanan
                    penerbitan yang modern.</h3>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <p class="">ITY Press menjadi pusat penerbitan buku berbasis digital dan cetak yang andal,
                        profesional, aktif, dan kreatif di tingkat nasional dan internasional.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <p class="">Memberikan layanan jasa cetak dan penerbitan buku kepada civitas akademika ITY
                        dan masyarakat.
                ...
                <div class="col-md-4">
                    ...
                    <p class="">Mendorong tumbuh dan berkembangnya budaya membaca, menulis, dan menerbitkan
                        buku.
                        Meningkatkan layanan pencetakan dan penerbitan buku, produksi buku digital, serta pelatihan di
    ...
    <section class="page-section" id="contact">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading ">Hubungi Kami Sekarang</h3>
                <a href="https://wa.me/6281548531603?text=Halo%20saya%20ingin%20mencetak%20buku%20saya%20sendiri"
                    class="whatsapp-button" target="_blank">Order via WhatsApp</a>
                </head>
            </div>
            <!-- Footer-->
            <footer class="footer py-4">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-4 text-lg-start">Copyright &copy; Institut Negeri Yogyakarta</div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <div class="modal-body">
                                        ...
                                        <img class="img-fluid d-block mx-auto" id="modalImage" src=""
                                            alt="..." />
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <img id="orderBookImage" src="" alt="Book"
                                                        class="img-fluid">
                                                </div>
                                                <div class="col-md-8">
                                                    <h6 id="orderBookTitle" class="fw-bold"></h6>
                                                    <p class="mb-1">Pengarang: <span id="orderBookAuthor"></span>
                                                    </p>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="metodePembayaran"
                                            id="virtualAccount" value="va" checked>
                            ...
                            <div id="paymentConfirmation" style="display: none;">
                                ...
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-2">Metode Pembayaran: <span id="confirmedPaymentMethod"></span>
                                        </p>
                                        <div id="confirmedBankInfo" style="display: none;">
                                            <p class="mb-2">Bank: <span id="confirmedBank"></span></p>
                                            <p class="mb-2">Nomor Rekening: <span
                                                    id="confirmedAccountNumber"></span></p>
                                        </div>
                                        <p class="mb-2">Total Pembayaran: Rp <span
                                                id="confirmedTotalPayment"></span></p>
                                    </div>
                                </div>
                            ...
                            <div id="paymentStatus" style="display: none;">
                                ...
                                <div id="paymentSuccessful" class="alert alert-success" style="display: none;">
                                    ...
                                    <p class="mb-0">Terima kasih atas pembayaran Anda. Pesanan Anda akan segera
                                        diproses.</p>
                                </div>
                                <div id="paymentPending" class="alert alert-warning" style="display: none;">
                                    <h6 class="fw-bold">Pembayaran Belum Dikonfirmasi</h6>
                                    <p class="mb-0">Kami belum menerima konfirmasi pembayaran Anda. Silakan coba lagi
                                        nanti.</p>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" id="confirmOrderBtn">Konfirmasi
                                Pesanan</button>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $.ajax({
        ...
        success: function(data) {
            // Iterasi setiap objek dalam data dan tambahkan ke bookData
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            <a class="portfolio-link" href="#" data-bs-toggle="modal" data-bs-target="#portfolioModal" data-book-id="${book.id}">
                                ...
                                <img class="img-fluid portfolio-image" src="{{url('/buku')}}/${book.image}" alt="${book.title}" />
                            </a>
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">${book.title}</div>
                                <div class="portfolio-caption-subheading ">Pengarang: ${book.author}</div>
                                <div class="portfolio-caption-price ">Harga: Rp ${book.price}</div>
                            </div>
                        </div>
                    </div>
                `;
        ...
        portfolioModal.addEventListener('show.bs.modal', function(event) {
            ...
            modalImage.src = `{{url("/buku")}}/` + book.image;
        ...
        paymentMethods.forEach(method => {
            method.addEventListener('change', function() {
                ...
                document.getElementById('totalPayment').textContent = (bookPrice + shippingCost)
        ...
        if (confirmOrderBtn) {
            confirmOrderBtn.addEventListener('click', function() {
                ...
                const metodePembayaran = document.querySelector(
                    'input[name="metodePembayaran"]:checked');
                ...
                if (isValid) {
                    ...
                    if (metodePembayaran.value === 'va') {
                        ...
                        document.getElementById('confirmedBank').textContent = bankSelect.value
                            .toUpperCase();
                        document.getElementById('confirmedAccountNumber').textContent = bankAccounts[
                            bankSelect.value];
                    }
